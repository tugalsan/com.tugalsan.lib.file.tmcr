...
public class TS_LibRepCodeInjectCompile {

    final private static TS_Log d = TS_Log.of( TS_LibRepCodeInjectCompile.class);

    public static TGS_Tuple3<String, Boolean, String> compile_CODE_INJECT_CODE(TS_LibRepParser_Globals macroGlobals) {
