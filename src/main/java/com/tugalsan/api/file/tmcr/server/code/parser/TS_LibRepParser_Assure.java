...
public class TS_LibRepParser_Assure {

    final private static TS_Log d = TS_Log.of(TS_LibRepParser_Assure.class);

    public static boolean checkTokenSize(TS_LibRepParser_Globals macroGlobals, int tokenSize) {
    ...
    public static boolean checkTokenSize(TS_LibRepParser_Globals macroGlobals, int[] tokenSizes) {
    ...
    public static TGS_LibRqlTbl getTable(TS_LibRepParser_Globals macroGlobals, String tableName) {
    ...
    public static String[] splitTableDotColname(TS_LibRepParser_Globals macroGlobals, int tableDotColnameIdx) {
    ...
    public static Integer getColumnIndex(TS_LibRepParser_Globals macroGlobals, TGS_LibRqlTbl table, String colname) {
    ...
    public static Long getId(TS_LibRepParser_Globals macroGlobals, int idIdx) {
        Long id;
        var token = macroGlobals.macroLineTokens.get(idIdx);
        if (token.equals(TS_LibRepParser_SelectedId.CODE_TOKEN_SELECTED_ID())) {
    ...
    public static String sniffCellSimple(TS_SQLConnAnchor anchor, TS_LibRepParser_Globals macroGlobals, TGS_LibRqlTbl table, long id, int colIdx) {
        if (d.infoEnable) {
            var tn = table.nameSql;
    ...
    public static String[] getVisibleTextAndSubId(TS_SQLConnAnchor anchor, TS_LibRepParser_Globals macroGlobals,
