...
public class TS_LibRepFileDOCX extends TS_LibRepFileInterface {

    final private static TS_Log d = TS_Log.of(TS_LibRepFileDOCX.class);
    ...
    private TS_LibRepFileDOCX(boolean enabled, Path localFile, TGS_Url remoteFile) {
        super(enabled, localFile, remoteFile);
    }

    public static void use(boolean enabled, TS_LibRepParser_Globals macroGlobals, Path localFile, TGS_Url remoteFile, TGS_RunnableType1<TS_LibRepFileDOCX> docx) {
        var instance = new TS_LibRepFileDOCX(enabled, localFile, remoteFile);
        try {
