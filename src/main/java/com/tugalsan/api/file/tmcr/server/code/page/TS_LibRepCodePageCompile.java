...
import static com.tugalsan.api.file.tmcr.server.code.page.TS_LibRepCodePageTags.CODE_INSERT_PAGE;
import static com.tugalsan.api.file.tmcr.server.code.page.TS_LibRepCodePageTags.CODE_TOKEN_A0;
import static com.tugalsan.api.file.tmcr.server.code.page.TS_LibRepCodePageTags.CODE_TOKEN_A1;
import static com.tugalsan.api.file.tmcr.server.code.page.TS_LibRepCodePageTags.CODE_TOKEN_A2;
import static com.tugalsan.api.file.tmcr.server.code.page.TS_LibRepCodePageTags.CODE_TOKEN_A3;
import static com.tugalsan.api.file.tmcr.server.code.page.TS_LibRepCodePageTags.CODE_TOKEN_A4;
import static com.tugalsan.api.file.tmcr.server.code.page.TS_LibRepCodePageTags.CODE_TOKEN_A5;
import static com.tugalsan.api.file.tmcr.server.code.page.TS_LibRepCodePageTags.CODE_TOKEN_A6;
import static com.tugalsan.api.file.tmcr.server.code.page.TS_LibRepCodePageTags.CODE_TOKEN_LAND;
import static com.tugalsan.api.file.tmcr.server.code.page.TS_LibRepCodePageTags.CODE_TOKEN_PORT;
import com.tugalsan.api.file.tmcr.server.code.parser.*;
import java.util.*;

public class TS_LibRepCodePageCompile {

    final private static TS_Log d = TS_Log.of(TS_LibRepCodePageCompile.class);
    ...
    public static boolean is_INSERT_PAGE(TS_LibRepParser_Globals macroGlobals) {
        return macroGlobals.macroLine.startsWith(CODE_INSERT_PAGE());
    }

    public static TGS_Tuple3<String, Boolean, String> compile_INSERT_PAGE(TS_LibRepParser_Globals macroGlobals) {
        var result = d.createFuncBoolean("compile_INSERT_PAGE");
        if (!TS_LibRepParser_Assure.checkTokenSize(macroGlobals, 7)) {
            return d.returnError(result, "Token size not 7 error @[" + macroGlobals.macroLine + "]");
        }
        boolean land;
        var landText = TGS_CharSetCast.toLocaleUpperCase(macroGlobals.macroLineTokens.get(2));
    ...
    public static boolean createNewPageDefault(TS_LibRepParser_Globals macroGlobals) {
