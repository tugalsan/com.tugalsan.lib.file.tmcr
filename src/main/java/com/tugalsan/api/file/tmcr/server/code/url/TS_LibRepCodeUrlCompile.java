...
import static com.tugalsan.api.file.tmcr.server.code.url.TS_LibRepCodeUrlTags.CODE_URL_SH_NEW;
import static com.tugalsan.api.file.tmcr.server.code.url.TS_LibRepCodeUrlTags.CODE_URL_SH_OLD;
import static com.tugalsan.api.file.tmcr.server.code.url.TS_LibRepCodeUrlWriter.CODE_URL_LOCALHOST;

public class TS_LibRepCodeUrlCompile {

    final private static TS_Log d = TS_Log.of(TS_LibRepCodeUrlCompile.class);

    public static boolean is_CODE_URL_SH_OLD(TS_LibRepParser_Globals macroGlobals, int idx) {
        return TGS_CharSetCast.containsLocaleIgnoreCase(macroGlobals.macroLines.get(idx), CODE_URL_SH_OLD());
    }

    public static boolean is_CODE_URL_LOCALHOST(TS_LibRepParser_Globals macroGlobals, int idx) {
        return TGS_CharSetCast.containsLocaleIgnoreCase(macroGlobals.macroLines.get(idx), CODE_URL_LOCALHOST());
    }

    public static TGS_Tuple3<String, Boolean, String> compile_CODE_URL_SH_OLD(TS_LibRepParser_Globals macroGlobals, int idx) {
    ...
    public static TGS_Tuple3<String, Boolean, String> compile_CODE_URL_LOCALHOST(TS_SQLConnAnchor anchor, TS_LibRepParser_Globals macroGlobals, int idx) {
