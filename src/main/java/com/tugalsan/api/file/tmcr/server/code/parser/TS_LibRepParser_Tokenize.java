...
public class TS_LibRepParser_Tokenize {

    final private static TS_Log d = TS_Log.of(TS_LibRepParser_Tokenize.class);

    public static TGS_Tuple3<String, Boolean, String> compile_TOKENIZE(TS_LibRepParser_Globals macroGlobals, int i) {
