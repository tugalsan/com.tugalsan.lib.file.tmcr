...
public class TS_LibRepFileWeb extends TS_LibRepFileInterface {

    final private static TS_Log d = TS_Log.of(TS_LibRepFileWeb.class);
    ...
    private TS_LibRepFileWeb(boolean enabled, Path localFile, TGS_Url remoteFile, boolean isBase64, int widthScalePercent, int fontHeightScalePercent) {
    ...
    public static void use(boolean enabled, TS_LibRepParser_Globals macroGlobals, Path localFile, TGS_Url remoteFile, boolean isBase64, int widthScalePercent, int fontHeightScalePercent, TGS_RunnableType1<TS_LibRepFileWeb> web) {
        var instance = new TS_LibRepFileWeb(enabled, localFile, remoteFile, isBase64, widthScalePercent, fontHeightScalePercent);
        try {
...
//            d.ci("addImageWeb", "w", mWidth, "h", mHeight, "r", rotationInDegrees_0_90_180_270);
            mImageLoc = TS_LibRepFileConverter.convertLocalLocationToRemote(macroGlobals, mImageLoc);
            if (mImageLoc == null) {
...
//                sh = ((int) (selectedWidth * height / width) + "px");
    ...
    private String getFontColor() {
        ...
        if (Objects.equals(macroGlobals.fontColor, TS_LibRepCodeFontTags.CODE_TOKEN_FONT_COLOR_BLUE())) {
            return "#0000FF";
        }
        if (Objects.equals(macroGlobals.fontColor, TS_LibRepCodeFontTags.CODE_TOKEN_FONT_COLOR_CYAN())) {
            return "#00FFFF";
        }
        if (Objects.equals(macroGlobals.fontColor, TS_LibRepCodeFontTags.CODE_TOKEN_FONT_COLOR_DARK_GRAY())) {
            return "#505050";
        }
        if (Objects.equals(macroGlobals.fontColor, TS_LibRepCodeFontTags.CODE_TOKEN_FONT_COLOR_GRAY())) {
            return "#808080";
        }
        if (Objects.equals(macroGlobals.fontColor, TS_LibRepCodeFontTags.CODE_TOKEN_FONT_COLOR_GREEN())) {
            return "#008000";
        }
        if (Objects.equals(macroGlobals.fontColor, TS_LibRepCodeFontTags.CODE_TOKEN_FONT_COLOR_LIGHT_GRAY())) {
            return "#D3D3D3";
        }
        if (Objects.equals(macroGlobals.fontColor, TS_LibRepCodeFontTags.CODE_TOKEN_FONT_COLOR_MAGENTA())) {
            return "#FF00FF";
        }
        if (Objects.equals(macroGlobals.fontColor, TS_LibRepCodeFontTags.CODE_TOKEN_FONT_COLOR_ORANGE())) {
            return "#FFA500";
        }
        if (Objects.equals(macroGlobals.fontColor, TS_LibRepCodeFontTags.CODE_TOKEN_FONT_COLOR_PINK())) {
            return "#FFC0CB";
        }
        if (Objects.equals(macroGlobals.fontColor, TS_LibRepCodeFontTags.CODE_TOKEN_FONT_COLOR_RED())) {
            return "#FF0000";
        }
        if (Objects.equals(macroGlobals.fontColor, TS_LibRepCodeFontTags.CODE_TOKEN_FONT_COLOR_YELLOW())) {
            return "#FFFF00";
        }
