...
public class TS_LibRepFileConverter {

    final private static TS_Log d = TS_Log.of(TS_LibRepFileConverter.class);

    public static String convertLocalLocationToRemote(TS_LibRepParser_Globals macroGlobals, String imageLoc_pathOrUrl) {
        //IF URL, RETURN
