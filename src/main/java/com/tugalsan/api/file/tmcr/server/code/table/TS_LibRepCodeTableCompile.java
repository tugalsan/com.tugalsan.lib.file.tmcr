...
public class TS_LibRepCodeTableCompile {

    final private static TS_Log d = TS_Log.of(TS_LibRepCodeTableCompile.class);

    public static boolean is_BEGIN_TABLE(TS_LibRepParser_Globals macroGlobals) {
        return macroGlobals.macroLine.startsWith(CODE_BEGIN_TABLE());
    }

    public static boolean is_END_TABLE(TS_LibRepParser_Globals macroGlobals) {
        return macroGlobals.macroLine.startsWith(CODE_END_TABLE());
    }

    public static boolean is_BEGIN_TABLECELL(TS_LibRepParser_Globals macroGlobals) {
        return macroGlobals.macroLine.startsWith(CODE_BEGIN_TABLECELL());
    }

    public static boolean is_END_TABLECELL(TS_LibRepParser_Globals macroGlobals) {
        return macroGlobals.macroLine.startsWith(CODE_END_TABLECELL());
    }

    public static boolean is_TABLECELL_BORDER(TS_LibRepParser_Globals macroGlobals) {
        return macroGlobals.macroLine.startsWith(CODE_TABLECELL_BORDER());
    }

    public static TGS_Tuple3<String, Boolean, String> compile_BEGIN_TABLECELL(TS_LibRepParser_Globals macroGlobals) {
        var result = d.createFuncBoolean("compile_BEGIN_TABLECELL");
        if (!TS_LibRepParser_Assure.checkTokenSize(macroGlobals, 4)) {
    ...
    public static TGS_Tuple3<String, Boolean, String> compile_END_TABLECELL(TS_LibRepParser_Globals macroGlobals) {
    ...
    public static TGS_Tuple3<String, Boolean, String> compile_TABLECELL_BORDER(TS_LibRepParser_Globals macroGlobals) {
    ...
    public static TGS_Tuple3<String, Boolean, String> compile_BEGIN_TABLE(TS_LibRepParser_Globals macroGlobals) {
    ...
    public static TGS_Tuple3<String, Boolean, String> compile_END_TABLE(TS_LibRepParser_Globals macroGlobals) {
