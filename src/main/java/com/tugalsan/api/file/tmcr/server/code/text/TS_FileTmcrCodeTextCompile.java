...
import static com.tugalsan.api.file.tmcr.server.code.text.TS_FileTmcrCodeTextTags.CODE_ADD_TEXT;
import static com.tugalsan.api.file.tmcr.server.code.text.TS_FileTmcrCodeTextTags.CODE_ADD_TEXT_COLNAME;
import static com.tugalsan.api.file.tmcr.server.code.text.TS_FileTmcrCodeTextTags.CODE_ADD_TEXT_CREATE_DATE;
import static com.tugalsan.api.file.tmcr.server.code.text.TS_FileTmcrCodeTextTags.CODE_ADD_TEXT_CREATE_USER;
import static com.tugalsan.api.file.tmcr.server.code.text.TS_FileTmcrCodeTextTags.CODE_ADD_TEXT_CW;
import static com.tugalsan.api.file.tmcr.server.code.text.TS_FileTmcrCodeTextTags.CODE_ADD_TEXT_DATE;
import static com.tugalsan.api.file.tmcr.server.code.text.TS_FileTmcrCodeTextTags.CODE_ADD_TEXT_FUNCNAME;
import static com.tugalsan.api.file.tmcr.server.code.text.TS_FileTmcrCodeTextTags.CODE_ADD_TEXT_HR;
import static com.tugalsan.api.file.tmcr.server.code.text.TS_FileTmcrCodeTextTags.CODE_ADD_TEXT_HTML;
import static com.tugalsan.api.file.tmcr.server.code.text.TS_FileTmcrCodeTextTags.CODE_ADD_TEXT_NEWLINE;
import static com.tugalsan.api.file.tmcr.server.code.text.TS_FileTmcrCodeTextTags.CODE_ADD_TEXT_REVLST_DATE;
import static com.tugalsan.api.file.tmcr.server.code.text.TS_FileTmcrCodeTextTags.CODE_ADD_TEXT_REVLST_NO;
import static com.tugalsan.api.file.tmcr.server.code.text.TS_FileTmcrCodeTextTags.CODE_ADD_TEXT_REVLST_USER;
import static com.tugalsan.api.file.tmcr.server.code.text.TS_FileTmcrCodeTextTags.CODE_ADD_TEXT_SPC;
import static com.tugalsan.api.file.tmcr.server.code.text.TS_FileTmcrCodeTextTags.CODE_ADD_TEXT_TABNAME;
import static com.tugalsan.api.file.tmcr.server.code.text.TS_FileTmcrCodeTextTags.CODE_ADD_TEXT_TIME;
import static com.tugalsan.api.file.tmcr.server.code.text.TS_FileTmcrCodeTextTags.CODE_ADD_TEXT_USER;
import static com.tugalsan.api.file.tmcr.server.code.text.TS_FileTmcrCodeTextTags.CODE_ADD_TEXT_VAR_FROMSQL;
import static com.tugalsan.api.file.tmcr.server.code.text.TS_FileTmcrCodeTextTags.CODE_ADD_TEXT_VAR_FROMSQL_REVERSE;
import static com.tugalsan.api.file.tmcr.server.code.text.TS_FileTmcrCodeTextTags.CODE_ADD_TEXT_VAR_FROM_SQLQUERY;
import static com.tugalsan.api.file.tmcr.server.code.text.TS_FileTmcrCodeTextTags.CODE_BEGIN_TEXT;
import static com.tugalsan.api.file.tmcr.server.code.text.TS_FileTmcrCodeTextTags.CODE_END_TEXT;
import static com.tugalsan.api.file.tmcr.server.code.text.TS_FileTmcrCodeTextTags.CODE_TOKEN_JUST;
import static com.tugalsan.api.file.tmcr.server.code.text.TS_FileTmcrCodeTextTags.CODE_TOKEN_LEFT;
import static com.tugalsan.api.file.tmcr.server.code.text.TS_FileTmcrCodeTextTags.CODE_TOKEN_RIGHT;
...
//            d.ce(CODE_BEGIN_TEXT() + " ERROR: code token[1] error! -> SET Default as ", CODE_TOKEN_LEFT());
    ...
    public static TGS_Tuple3<String, Boolean, String> compile_ADD_TEXT_CREATE_DATE(TS_SQLConnAnchor anchor, TS_FileTmcrParser_Globals macroGlobals) {
        ...
        Long id;
        if (macroGlobals.macroLineTokens.get(2).equals(TS_FileTmcrParser_SelectedId.CODE_TOKEN_SELECTED_ID())) {
    ...
    public static TGS_Tuple3<String, Boolean, String> compile_ADD_TEXT_VAR_FROMSQL_or_REVERSE(TS_SQLConnAnchor anchor, TS_FileTmcrParser_Globals macroGlobals, boolean filenameMode) {
        ...
        var data = TS_FileTmcrParser_Assure.sniffCellSimple(anchor, macroGlobals, table, id, colIdx);//FIX THAT THING IMMATDIATELY!!!
        if (data == null) {
            return d.returnError(result, "data == null");
        }
