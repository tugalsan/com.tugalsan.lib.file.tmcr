...
public class TS_LibRepCodeFileNameWriter {
    ...
    public static List<String> buildFileNameWithAddTextCommands(TGS_RunnableType1<List> commands) {
        ...
        allCommands.add(0, TS_LibRepCodeFileNameTags.CODE_FILENAME_START());
        allCommands.add(TS_LibRepCodeFileNameTags.CODE_FILENAME_END());
        return allCommands;
    }
}
