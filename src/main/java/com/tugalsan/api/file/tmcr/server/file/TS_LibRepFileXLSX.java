...
public class TS_LibRepFileXLSX extends TS_LibRepFileInterface {

    final private static TS_Log d = TS_Log.of(TS_LibRepFileXLSX.class);
    ...
    private TS_LibRepFileXLSX(boolean enabled, Path localFile, TGS_Url remoteFile) {
        super(enabled, localFile, remoteFile);
    }

    public static void use(boolean enabled, TS_LibRepParser_Globals macroGlobals, Path localFile, TGS_Url remoteFile, TGS_RunnableType1<TS_LibRepFileXLSX> xlsx) {
        var instance = new TS_LibRepFileXLSX(enabled, localFile, remoteFile);
        try {
...
//                                d("compileFile.*** skipping cell :" + table.getValueAsObject(ri, ci));
    ...
    private static class TS_MIFXLSX_RichCell {
        ...
        List<Font> fonts;
        TS_FileXlsx xlsx;
        TS_LibRepParser_Globals macroGlobals;
        int rowIdx, colIdx;
        ...
        public TS_MIFXLSX_RichCell(TS_FileXlsx xlsx, TS_LibRepParser_Globals macroGlobals, Integer rowSpan, Integer colSpan, Integer rowHeight, Integer colSpanSize) {
            this.macroGlobals = macroGlobals;
            this.xlsx = xlsx;
