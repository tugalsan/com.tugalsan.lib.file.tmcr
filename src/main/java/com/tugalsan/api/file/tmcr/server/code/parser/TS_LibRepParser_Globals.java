...
public class TS_LibRepParser_Globals {

//    final private static TS_Log d = TS_Log.of(TS_LibRepParser_Globals.class);
    ...
    //AUTOMATION
    public TS_LibRepFileHandler mifHandler;
    ...
    public String getHexColor() {
        ...
        if (Objects.equals(fontColor, TS_LibRepCodeFontTags.CODE_TOKEN_FONT_COLOR_RED())) {
            return "FF0000";
        } else if (Objects.equals(fontColor, TS_LibRepCodeFontTags.CODE_TOKEN_FONT_COLOR_YELLOW())) {
            return "FFFF00";
        } else if (Objects.equals(fontColor, TS_LibRepCodeFontTags.CODE_TOKEN_FONT_COLOR_BLUE())) {
            return "0000FF";
        } else if (Objects.equals(fontColor, TS_LibRepCodeFontTags.CODE_TOKEN_FONT_COLOR_GREEN())) {
            return "00FF00";
        } else if (Objects.equals(fontColor, TS_LibRepCodeFontTags.CODE_TOKEN_FONT_COLOR_PINK())) {
            return "FFC0CB";
        } else if (Objects.equals(fontColor, TS_LibRepCodeFontTags.CODE_TOKEN_FONT_COLOR_ORANGE())) {
            return "FFA500";
        } else if (Objects.equals(fontColor, TS_LibRepCodeFontTags.CODE_TOKEN_FONT_COLOR_CYAN())) {
            return "00FFFF";
        } else if (Objects.equals(fontColor, TS_LibRepCodeFontTags.CODE_TOKEN_FONT_COLOR_DARK_GRAY())) {
            return "585858";
        } else if (Objects.equals(fontColor, TS_LibRepCodeFontTags.CODE_TOKEN_FONT_COLOR_GRAY())) {
            return "808080";
        } else if (Objects.equals(fontColor, TS_LibRepCodeFontTags.CODE_TOKEN_FONT_COLOR_LIGHT_GRAY())) {
            return "D3D3D3";
        } else if (Objects.equals(fontColor, TS_LibRepCodeFontTags.CODE_TOKEN_FONT_COLOR_MAGENTA())) {
            return "6D1717";
    ...
    public String toString() {
        return TS_LibRepParser_Globals.class.getSimpleName() + "{" + "runReport=" + runReport + ", username=" + username + ", tablename=" + tablename + ", selectedId=" + selectedId + ", funcName=" + funcName + ", userDotTablename=" + userDotTablename + ", url=" + url + ", dirDat=" + dirDat + '}';
    }

    public TS_LibRepParser_Globals(TS_SQLConnAnchor anchor,
        ...
        this.fontItalic = false;
        this.fontHeight = 12;
        this.fontColor = TS_LibRepCodeFontTags.CODE_TOKEN_FONT_COLOR_BLACK();
