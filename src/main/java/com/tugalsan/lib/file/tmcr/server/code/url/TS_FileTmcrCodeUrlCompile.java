...
public class TS_FileTmcrCodeUrlCompile {
    ...
    public static boolean is_CODE_URL_SH_OLD(TS_FileCommonBall macroGlobals, int idx) {
        return TGS_CharSetCast.containsLocaleIgnoreCase(macroGlobals.macroLines.get(idx), CODE_URL_SH_OLD());
    }

    public static boolean is_CODE_URL_LOCALHOST(TS_FileCommonBall macroGlobals, int idx) {
        return TGS_CharSetCast.containsLocaleIgnoreCase(macroGlobals.macroLines.get(idx), CODE_URL_LOCALHOST());
    }

    public static TGS_Tuple3<String, Boolean, String> compile_CODE_URL_SH_OLD(TS_FileCommonBall macroGlobals, int idx) {
    ...
    public static TGS_Tuple3<String, Boolean, String> compile_CODE_URL_LOCALHOST(TS_SQLConnAnchor anchor, TS_FileCommonBall macroGlobals, int idx) {
