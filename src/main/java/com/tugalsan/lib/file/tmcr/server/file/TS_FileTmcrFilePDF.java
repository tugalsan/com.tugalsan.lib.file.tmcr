...
public class TS_FileTmcrFilePDF extends TS_FileTmcrFileInterface {

    final private static TS_Log d = TS_Log.of(TS_FileTmcrFilePDF.class);
    ...
    private TS_FileTmcrFilePDF(boolean enabled, Path localFile, TGS_Url remoteFile) {
        super(enabled, localFile, remoteFile);
    }

    public static void use(boolean enabled, TS_FileTmcrParser_Globals macroGlobals, Path localFile, TGS_Url remoteFile, TGS_RunnableType1<TS_FileTmcrFilePDF> pdf) {
        var instance = new TS_FileTmcrFilePDF(enabled, localFile, remoteFile);
        try {
