...
public class TS_FileTmcrCodeTextCompile {
    ...
    public static TGS_Tuple3<String, Boolean, String> compile_BEGIN_TEXT(TS_FileCommonConfig fileCommonConfig, TS_FileTmcrFileHandler mifHandler) {
        ...
        var allignText = TGS_CharSetCast.toLocaleUpperCase(fileCommonConfig.macroLineTokens.get(1));
...
//            d.ce(CODE_BEGIN_TEXT() + " ERROR: code token[1] error! -> SET Default as ", CODE_TOKEN_LEFT());
    ...
    public static TGS_Tuple3<String, Boolean, String> compile_END_TEXT(TS_FileCommonConfig fileCommonConfig, TS_FileTmcrFileHandler mifHandler) {
    ...
    public static TGS_Tuple3<String, Boolean, String> compile_ADD_TEXT(TS_FileCommonConfig fileCommonConfig, TS_FileTmcrFileHandler mifHandler, boolean filenameMode) {
    ...
    public static TGS_Tuple3<String, Boolean, String> compile_ADD_TEXT_CREATE_DATE(TS_SQLConnAnchor anchor, TS_FileCommonConfig fileCommonConfig, TS_FileTmcrFileHandler mifHandler) {
        var result = d.createFuncBoolean("compile_ADD_TEXT_CREATE_DATE");
        if (!TS_FileTmcrParser_Assure.checkTokenSize(fileCommonConfig, 3)) {
        ...
        Long id;
        if (fileCommonConfig.macroLineTokens.get(2).equals(TS_FileTmcrParser_SelectedId.CODE_TOKEN_SELECTED_ID())) {
    ...
    public static TGS_Tuple3<String, Boolean, String> compile_ADD_TEXT_CREATE_USER(TS_SQLConnAnchor anchor, TS_FileCommonConfig fileCommonConfig, TS_FileTmcrFileHandler mifHandler) {
    ...
    public static TGS_Tuple3<String, Boolean, String> compile_ADD_TEXT_REVLST_DATE(TS_SQLConnAnchor anchor, TS_FileCommonConfig fileCommonConfig, TS_FileTmcrFileHandler mifHandler) {
    ...
    public static TGS_Tuple3<String, Boolean, String> compile_ADD_TEXT_REVLST_USER(TS_SQLConnAnchor anchor, TS_FileCommonConfig fileCommonConfig, TS_FileTmcrFileHandler mifHandler) {
    ...
    public static TGS_Tuple3<String, Boolean, String> compile_ADD_TEXT_REVLST_NO(TS_SQLConnAnchor anchor, TS_FileCommonConfig fileCommonConfig, TS_FileTmcrFileHandler mifHandler) {
    ...
    public static TGS_Tuple3<String, Boolean, String> compile_ADD_TEXT_USER(TS_FileCommonConfig fileCommonConfig, TS_FileTmcrFileHandler mifHandler) {
    ...
    public static TGS_Tuple3<String, Boolean, String> compile_ADD_TEXT_NEWLINE(TS_FileCommonConfig fileCommonConfig, TS_FileTmcrFileHandler mifHandler) {
    ...
    public static TGS_Tuple3<String, Boolean, String> compile_ADD_TEXT_SPC(TS_FileCommonConfig fileCommonConfig, TS_FileTmcrFileHandler mifHandler, boolean filenameMode) {
    ...
    public static TGS_Tuple3<String, Boolean, String> compile_ADD_TEXT_TIME(TS_FileCommonConfig fileCommonConfig, TS_FileTmcrFileHandler mifHandler) {
    ...
    public static TGS_Tuple3<String, Boolean, String> compile_ADD_TEXT_DATE(TS_FileCommonConfig fileCommonConfig, TS_FileTmcrFileHandler mifHandler) {
    ...
    public static TGS_Tuple3<String, Boolean, String> compile_ADD_TEXT_HR(TS_FileCommonConfig fileCommonConfig, TS_FileTmcrFileHandler mifHandler) {
    ...
    public static TGS_Tuple3<String, Boolean, String> compile_ADD_TEXT_FUNCNAME(TS_FileCommonConfig fileCommonConfig, TS_FileTmcrFileHandler mifHandler) {
    ...
    public static TGS_Tuple3<String, Boolean, String> compile_ADD_TEXT_VAR_FROM_SQLQUERY(TS_SQLConnAnchor anchor, TS_FileCommonConfig fileCommonConfig, TS_FileTmcrFileHandler mifHandler) {
    ...
    //ADD_TEXT_CW VAR ID
    public static TGS_Tuple3<String, Boolean, String> compile_ADD_TEXT_CW(TS_SQLConnAnchor anchor, TS_FileCommonConfig fileCommonConfig, TS_FileTmcrFileHandler mifHandler) {
        ...
        Integer colIdx;
        {
            var tableAndColname = TS_FileTmcrParser_Assure.splitTableDotColname(fileCommonConfig, 1);
            ...
            colIdx = TS_FileTmcrParser_Assure.getColumnIndex(fileCommonConfig, table, tableAndColname[1]);
            if (colIdx == null) {
                return d.returnError(result, "colIdx == null");
            }
        }
        var column = table.columns.get(colIdx);
        var id = TS_FileTmcrParser_Assure.getId(fileCommonConfig, mifHandler, 2);
        if (id == null) {
            return d.returnError(result, "id == null");
        }
        d.ci("id returns as: ", id);

        var data = TS_FileTmcrParser_Assure.sniffCellSimple(anchor, fileCommonConfig, table, id, colIdx);
        if (data == null) {
    ...
    public static TGS_Tuple3<String, Boolean, String> compile_ADD_TEXT_VAR_FROMSQL_or_REVERSE(TS_SQLConnAnchor anchor, TS_FileCommonConfig fileCommonConfig, TS_FileTmcrFileHandler mifHandler, boolean filenameMode) {
        ...
        var data = TS_FileTmcrParser_Assure.sniffCellSimple(anchor, fileCommonConfig, table, id, colIdx);//FIX THAT THING IMMATDIATELY!!!
        if (data == null) {
            return d.returnError(result, "data == null");
        }
        ...
        var visibleTextAndSubId = TS_FileTmcrParser_Assure.getVisibleTextAndSubId(anchor, fileCommonConfig, tn, column, data);
    ...
    public static TGS_Tuple3<String, Boolean, String> compile_ADD_TEXT_TABNAME(TS_FileCommonConfig fileCommonConfig, TS_FileTmcrFileHandler mifHandler) {
    ...
    public static TGS_Tuple3<String, Boolean, String> compile_ADD_TEXT_COLNAME(TS_SQLConnAnchor anchor, TS_FileCommonConfig fileCommonConfig, TS_FileTmcrFileHandler mifHandler) {
