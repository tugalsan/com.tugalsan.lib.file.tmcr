...
public class TS_FileTmcrFileTMCR extends TS_FileCommonAbstract {
    ...
    public static void use(boolean enabled, TS_FileCommonConfig fileCommonConfig, Path localFile, TGS_Url remoteFile, TGS_CallableType1_Run<TS_FileTmcrFileTMCR> tmcr) {
